  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-card border border-border p-6 shadow-2xl space-y-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <button
          onClick={dismiss}
          className="absolute top-4 right-4 text-muted-foreground/70 hover:text-muted-foreground dark:hover:text-muted-foreground/70 transition-colors"
          aria-label="Close"
        >
          <X className="h-5 w-5" />
        </button>
        ...
        <button
          onClick={dismiss}
          className="w-full text-center text-sm text-muted-foreground/70 hover:text-muted-foreground dark:hover:text-muted-foreground/70 transition-colors"
        >
          {t.pro.maybeLater}
        </button>
      </div>
