...
export function ExpiryBanner() {
      ...
      <div className="bg-red-600 text-white px-4 py-2.5 text-center text-sm">
        <div className="flex items-center justify-center gap-2">
          ...
          <Link
            ...
            className="ml-2 rounded-md bg-white px-3 py-0.5 text-xs font-semibold text-red-600 hover:bg-red-50"
          >
  ...
  if (isExpiringSoon && isPro) {
    return (
      <div className="bg-amber-500 text-white px-4 py-2.5 text-sm">
        <div className="flex items-center justify-center gap-2">
          ...
          <Link
            href="/dashboard/subscription"
            className="ml-2 rounded-md bg-white px-3 py-0.5 text-xs font-semibold text-amber-600 hover:bg-amber-50"
          >
