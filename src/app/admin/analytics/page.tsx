          ...
          <CardContent className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-foreground">
                {estimatedMRR.toLocaleString()} <span className="text-sm font-normal text-muted-foreground/70">FCFA</span>
              </p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-foreground">{proStudents}</p>
            </div>
          </CardContent>
        </Card>
        <Card>
                ...
                users.map((user) => (
                  <div key={user.id} className="grid grid-cols-12 gap-4 px-4 py-3 items-center">
                    ...
                    <div className="col-span-2">
                      <Badge
                        variant="secondary"
                        className={user.subscription_tier === "pro" ? "bg-amber-100 text-amber-700" : "bg-muted text-muted-foreground"}
                      >
