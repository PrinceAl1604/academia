      ...
      <div className="mx-auto max-w-2xl px-4 pb-20">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-foreground/90">
          <section>
            ...
            <p className="mt-2">By using Visible, you agree to these terms. If you do not agree, please do not use our platform.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">All course content is owned by Visible. You may not reproduce, distribute, or share course materials without written permission.</p>
          </section>
